...
export default function BibleScreen() {
  ...
  const {
    ...
    queryKey: ["bible", book?.id, book?.name, currentChapter, book],
    queryFn: async () => {
      if (!book) return [];
      return await fetchChapter(book.id, book.name, currentChapter);
    },
    enabled: !!book,
    staleTime: Infinity,
  });
  ...
  }, [targetVerse, verses, setTargetVerse, flickerAnim]);
